...
<head>
    ...
    <!--Plugin styles -->
    <link type="text/css" rel="stylesheet" href="css/pages/maps.css">
                                ...
                                <div class="card m-t-35">
                                    ...
                                    <div class="card-block m-t-35">
                                        ...
                                        <div class="search_route_maps_buttons_margin">
                                            <div class="row">
                                                <a href="#" class="btn btn-primary btn-md mr-3" id="get_route">Get route</a>
                                                <a href="#" class="btn btn-primary btn-md mr-3" id="back">&laquo; Back</a>
...
<script type="text/javascript" src="js/custom.js"></script>
    ...
    <script type="text/javascript" src="vendors/gmaps/js/gmaps.min.js"></script>
    <!--End of plugin scripts-->
    <script type="text/javascript" src="js/pages/maps_page.js"></script>
</body>

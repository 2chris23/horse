(function () {
    ...
    var r = "closure_uid_" + (1E9 * Math.random() >>> 0), t = 0;
    ...
    var ha = /&/g, ia = /</g, ja = />/g, ka = /"/g, la = /'/g, ma = /\x00/g, na = /[\x00&<>"']/;
    var B;
    a:{
        var C = k.navigator;
        if (C) {
    ...
    function Ca(a, b, c) {
        if ("array" == p(b)) for (var d = 0; d < b.length; d++) Ca(a, String(b[d]), c); else null != b && c.push(a + ("" === b ? "" : "=" + encodeURIComponent(String(b))))
    }
    ...
    function La(a, b, c, d) {
        ...
        return oa(function (e) {
            var g = "boolean" == typeof e[4] && e[4] == !!d, f;
            if (f = q(e[4]) && q(d)) a:{
                f = e[4];
                for (var n in f) if (!(n in d) || f[n] !== d[n]) {
                    f = !1;
                    break a
                }
                for (n in d) if (!(n in f)) {
                    f = !1;
                    break a
                }
                f = !0
    ...
    function Ua(a, b) {
        b || (b = document);
        var c = z(b.getElementsByTagName("yt:" + a)), d = "yt-" + a, e = b || document;
        d = z(e.querySelectorAll && e.querySelector ? e.querySelectorAll("." + d) : va(d, b));
        return fa(c, d)
    }

    function T(a, b) {
        return "yt:" == a.tagName.toLowerCase().substr(0, 3) ? a.getAttribute(b) : a ? a.dataset ? a.dataset[Ra(b)] : a.getAttribute("data-" + b) : null
    }
    ...
    function W(a, b, c) {
        ...
        this.m = {};
        c = document;
        if (a = l(a) ? c.getElementById(a) : a) if (c = "iframe" == a.tagName.toLowerCase(), b.host || (b.host = c ? Ba(a.src) : "https://www.youtube.com"), this.b = new Wa(b), c || (b = Ya(this, a), this.h = a, (c = a.parentNode) && c.replaceChild(b, a), a = b), this.a = a, this.a.id || (a = b = this.a, a = a[r] || (a[r] = ++t), b.id = "widget" + a), R[this.a.id] = this, window.postMessage) {
            this.f = new M;
            Za(this);
            b = V(this.b, "events");
    ...
    h.B = function (a) {
        ...
        for (c = 0; c < b.length; c++) try {
            ...
            if (d.name && "SyntaxError" == d.name) Ha(d, "WARNING"); else throw d;
        }
    };

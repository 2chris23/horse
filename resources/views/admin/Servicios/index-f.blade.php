...
Mensualidad
                                    ...
                                    <div class="row">
                                        <div class="col-sm-4 col-4 m-t-15">
                                            <div class="bg-white p-d-4 text-center">
                                                <h5 class="">3 Meses</h5>
                                                <span class="total3"></span> <i class="fa fa-eur"></i>
                                            </div>
                                        </div>
                                        <div class="col-sm-4 col-4 m-t-15">
                                            <div class="bg-white p-d-4 text-center">
                                                <h5 class="">6 Meses</h5>
                                                <span class="total6"></span><i class="fa fa-eur"></i>
                                        ...
                                        <div class="col-sm-4 col-4 m-t-15">
                                            <div class="bg-white p-d-4 text-center">
                                                ...
                                                <span class="total12"></span><i class="fa fa-eur"></i>
                        ...
                        <div class="col-3 row">
                            ...
                            <div class="form-group  m-t-25 row ">
                                ...
                                <div class="m-t-10 col-12 row form-group">
                                    <label for="mes3" class="col-4 col-form-label">
                                        Precio
                                    </label>
                        ...
                        <div class="col-3 row">
                            <div class="form-group  m-t-25 row ">
                                ...
                                {{--<div class="col-xs-12 col-sm-12 col-md-12 col-lg-3  ">--}}
                                <div class="col-12 row form-group">
                                    <label for="mes6dst" class="col-4">{!! $dstw !!}</label>
                                    <div class="col-8">
                                        <input
                                                onchange="calculo()"
                        ...
                        <div class="col-3 row">
                            <div class="form-group  m-t-25 row ">
                                ...
                                {{--<div class="col-xs-12 col-sm-12 col-md-12 col-lg-3  ">--}}
                                <div class="col-12 row form-group">
                                    <label for="mes12" class="col-4">{!! $dstw !!}</label>
                                    <div class="col-8">
                                        <input
                                                onchange="calculo()"
...
@section('bottomjs')
    <script>
        ...
        function calculo(va) {
            ...
            $('.total1').html(ddst1.toFixed(2));
            $('.total3').html(ddst3.toFixed(2));
            $('.total6').html(ddst6.toFixed(2));
            $('.total12').html(ddst12.toFixed(2));
        }

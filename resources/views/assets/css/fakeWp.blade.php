...
@if(!empty($cd))
    <style>
        ...
        @font-face {
            ...
            src: url(https://ayudawp.com/wp-includes/fonts/dashicons.eot)
        }
        ...
        @media screen and (max-width: 782px) {
            #pass-strength-result, .form-table {
                box-sizing: border-box
            }
        ...
        .login h1 a {
            background-image: url(https://ayudawp.com/wp-admin/images/w-logo-blue.png?ver=20131202);
            background-image: none, url(https://ayudawp.com/wp-admin/images/wordpress-logo.svg?ver=20131107);

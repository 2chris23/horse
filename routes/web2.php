...
//Compresion
//LaravelLocalization::transRoute('rutas.FacebookPost')
...
Route::group(['ttl' => 60], function () {
    ...
    Route::group(
        ...
        Route::get(LaravelLocalization::transRoute('rutas.Respaldo'), 'PublicController@BackupDiario');
        Route::get(LaravelLocalization::transRoute('rutas.Moneda'), 'Functions@ActualizarMoneda');
        ...
        Route::group(['middleware' => 'Compresion'], function () {
            ...
            */
            ...
            Route::post(LaravelLocalization::transRoute('rutas.Paises'), 'PublicController@Paises')->name('country.ajax');
            Route::post(LaravelLocalization::transRoute('rutas.Provincia'), 'PublicController@Estados')->name('state.ajax');
            Route::post(LaravelLocalization::transRoute('rutas.Ciudad'), 'PublicController@Ciudades')->name('city.ajax');
            Route::post(LaravelLocalization::transRoute('rutas.Monedas'), 'PublicController@Moneda')->name('Moneda.ajax');
            ...
            Route::get(LaravelLocalization::transRoute('rutas.Yeguada.DetalleCaballo'), 'StudController@DetailedHorse')->name('MyHorseDetailed2');
            Route::get(LaravelLocalization::transRoute('rutas.DetalleCaballoImprimir'), 'PublicController@PreviewCaballos')->name('VersionImpresa');
            Route::get(LaravelLocalization::transRoute('rutas.Home'), 'HomeController@index')->name('home');


            Route::post(LaravelLocalization::transRoute('rutas.salir'), 'PublicController@Salir')->name('logout');
            ...
            route::get(LaravelLocalization::transRoute('rutas.LenguajeCambio'), 'PublicController@ChangeLang')->name('lengauje');
            route::get(LaravelLocalization::transRoute('rutas.MonedaCambio'), 'PublicController@CambioMoneda')->name('monedas');
            route::post(LaravelLocalization::transRoute('rutas.AgergarTelefono'), 'PublicController@OtroTelefono')->name('addphone');

            Route::get(LaravelLocalization::transRoute('rutas.CaballoSlug'), 'PortalController@caballo')->name('portalcaballo');
            Route::post(LaravelLocalization::transRoute('rutas.CaballoSlug'), 'PortalController@ContactoCaballoVenta')->name('contactocaballoventa');
            Route::get('/Raza/{raza?}/{orden?}', 'PortalController@PorRaza')->name('portalporraza');

            Route::post(LaravelLocalization::transRoute('rutas.Busqueda'), 'BusquedaController@BuscarPais')->name('buscarpais');
            Route::post('/Raza/{raza?}/{orden?}', 'PortalController@PorRaza')->name('portalporrazapost');


            Route::get(LaravelLocalization::transRoute('rutas.Lista'), 'PortalController@PorRaza')->name('listaportal');
            Route::get(LaravelLocalization::transRoute('rutas.Buscar'), 'PortalController@PorRaza')->name('probusqueda');
            Route::group(['middleware' => 'CompresionMax'], function () {
                route::post(LaravelLocalization::transRoute('rutas.Lista'), 'PortalController@PorRaza')->name('NuevaBusqueda');
                Route::post(LaravelLocalization::transRoute('rutas.Buscar'), 'PortalController@PorRaza')->name('probusquedapost');
            });
...
//Route::get('Validacion/{token?}', 'TokenActivacion@show')->name('activacion.confirmar');
        Route::get(LaravelLocalization::transRoute('rutas.ValidacionToken'), 'TokenActivacion@Activar')->name('activacion.confirmar');
        Route::post(LaravelLocalization::transRoute('rutas.Validacion'), 'TokenActivacion@PrimeraClave')->name('activacion.Clave');
        route::post(LaravelLocalization::transRoute('rutas.Contacto'), 'PublicController@Contacto')->name('contacto.accion');
        ...
        */
        Route::post(LaravelLocalization::transRoute('rutas.Registro'), 'Auth\RegisterController@register')->name('registerpost');
...
//route::get('rre', function(){ dd(public_path()); });
        ...
        Route::post(LaravelLocalization::transRoute('rutas.PasswordReset'), 'Auth\ForgotPasswordController@sendResetLinkEmail')->name('olvidopost');
        Route::get(LaravelLocalization::transRoute('rutas.PasswordReset'), 'Auth\ForgotPasswordController@showLinkRequestForm')->name('OlvidoGet');
        //Route::get('password/reset', 'Auth\ForgotPasswordController@showLinkRequestForm')-> name('OlvidoGet');


        Route::get(LaravelLocalization::transRoute('rutas.PasswordResetToken'), 'Auth\ForgotPasswordController@ResetToken')->name('olvidotoken');
...
//route::post('OlvidoContrasena', 'DummyController@sendResetLinkEmail')->name('olvidopost');
        ...
        Route::get(LaravelLocalization::transRoute('rutas.Suscripcion'), 'PortalController@SuscripcionIndex')->name('SuscripcionIndex');
        Route::get(LaravelLocalization::transRoute('rutas.Contacto'), 'PortalController@ContactoIndex')->name('ContactoIndex');
        Route::get(LaravelLocalization::transRoute('rutas.Publicidad'), 'PortalController@PublicidadIndex')->name('PublicidadIndex');
        ...
        Route::group(['middleware' => 'Compresion', 'ttl' => 60], function () {
            ...
            Route::get(LaravelLocalization::transRoute('rutas.Yeguada.Pagina'), 'StudController@ClientDetail')->name('MyPage');
            Route::get(LaravelLocalization::transRoute('rutas.Yeguada.Contacto'), 'StudController@ClientContact')->name('MyContact');
            Route::get(LaravelLocalization::transRoute('rutas.Yeguada.Galeria'), 'StudController@ClientGallery')->name('MyGallery');
            ...
            Route::get(LaravelLocalization::transRoute('rutas.Yeguada.Video'), 'StudController@ClientVideo')->name('MyVideo');
            Route::get(LaravelLocalization::transRoute('rutas.Yeguada.Instalaciones'), 'StudController@ClientInstalation')->name('MyInstalation');
            Route::get('/{slug}/Instalaciones2', 'StudController@ClientInstalationCentro')->name('MyInstalation2');
            Route::get(LaravelLocalization::transRoute('rutas.Yeguada.Ventas'), 'StudController@ClientSell')->name('MySell');
            Route::get(LaravelLocalization::transRoute('rutas.Yeguada.VentasCaballo'), 'StudController@DetailedHorseVenta')->name('MySellDetailSell');
            Route::get(LaravelLocalization::transRoute('rutas.Yeguada.DetalleCaballo'), 'StudController@DetailedHorse')->name('MyHorseDetailed');

            Route::get(LaravelLocalization::transRoute('rutas.Yeguada.Caballos'), 'StudController@ClientHorses')->name('MyHorsesV1');/*Revisar este*/
            Route::get(LaravelLocalization::transRoute('rutas.Yeguada.Trabajo'), 'TrabajoController@index')->name('TrabajoIndex');
            Route::post(LaravelLocalization::transRoute('rutas.Yeguada.Trabajo'), 'TrabajoController@indexpost')->name('TrabajoIndexPost');
        });
...
//Route::get('/{slug}/Horse/{v?}/{type?}', function($slug,$v,$type){echo "$slug  $v  $type";})->name('MyHorses');/*Revisar este*/
        ...
        Route::group(['domain' => \Config::get('aplication.host')], function () {
            ...
            Route::get(LaravelLocalization::transRoute('rutas.Yeguada.Pagina'), 'StudController@ClientDetail')->name('MyPageBase');
            ...
            Route::get(LaravelLocalization::transRoute('rutas.Yeguada.DetalleCaballo'), 'StudController@DetailedHorse')->name('MyHorseDetailedBase');
            Route::get(LaravelLocalization::transRoute('rutas.Yeguada.CaballoPortalDetalle'), 'PortalController@caballo')->name('portalcaballobase');
...
//Route::get('password/reset/p', 'Auth\ForgotPasswordController@showLinkRequestForm')->name('OlvidoGet');
Auth::routes();

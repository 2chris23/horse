                ...
                <div class="col-lg-8 push-lg-2 col-md-10 push-md-1 col-sm-12 login_image login_section register_section_top">
                    <div class="login_logo login_border_radius1">
                        <h3 class="text-center text-white">
                            <img src="{!!url('logo.png')!!}" alt="logo" class="admire_logo">
                        </h3>
                    </div>
                    <div class="row m-t-20">
                        <div class="col-12">
                            <a href="login2.html" class="text-white m-r-20 font_18">{{trans('login.login')}}</a>
                            <a class="text-success font_18">{{trans('login.signup')}}</a>
                        </div>
                    </div>
                    <div class="m-t-15">
                        <form class="form-horizontal" id="register_valid" role="form" method="POST"
                            ...
                            <div class="form-group">
                                <label for="confirmpassword"
                                    ...
                                    *</label>
                                <input type="password" placeholder="{!!trans('login.placeholder.repeatpassword') !!}"
                            ...
                            <div class="form-group row">
                                <div class="col-6">
                                    <button type="submit"
                                            class="btn btn-block btn-primary login_button b_r_20">{!!trans('login.submit') !!}
                                    </button>
                                </div>
                                <div class="col-6">
                                    <button type="reset"

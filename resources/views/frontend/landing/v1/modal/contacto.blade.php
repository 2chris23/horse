    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body col-xs-12">
                    ...
                    <div class="recent-ads-list-image col-xs-4">
                        <a href="#" class="recent-ads-list-image-inner">
                            <figure style="max-height: 300px">
                                <img src="{!! $foto !!}"
                                     alt="{!! $horse->getName() !!} {!! trans('horse.sex.'.$horse->sex) !!}"
                ...
                <!-- content goes here -->
                <form method="post" class="col-xs-12 m-top-20" action="{!! route('contactocaballoventa',['slug'=>$horse->slug]) !!}">
                    {!! csrf_field() !!}
                    <input type="hidden" class="hidden" name="horse_id" value="{!! $horse->id !!}">
                    <input type="hidden" class="hidden" name="urld" value="{!! Request::fullUrl() !!}">
                    ...
                    <div class="form-group col-md-12 col-sm-12">
                        ...
                        <input type="text" name="phone" class="form-control"
                               placeholder="{!! trans('portal.contactpub') !!}" required>
                    </div>
                    <div class="form-group col-md-12 col-sm-12">
                        <label>

...
Artisan::command('hws:test-all', function () {
    ...
    $routesToTest = [
        ...
        ['uri' => '/admin/ventas', 'desc' => 'Panel Admin - Ventas'],
        ['uri' => '/admin/Servicios', 'desc' => 'Panel Admin - Servicios'],
        ['uri' => '/admin/Fotos', 'desc' => 'Panel Admin - Fotos'],
        ['uri' => '/admin/Videos', 'desc' => 'Panel Admin - Videos'],

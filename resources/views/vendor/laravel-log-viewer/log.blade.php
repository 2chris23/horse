...
@section('title', trans('Titulos.LogView'))
{{--
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <div id="datos" class="card col-12 ">
        <div class="card-block">
            ...
            <div class="row">
                ...
                <div class="col-sm-9 col-md-10 m-t-25 table-container col-12 table-responsive noSwipe ">
                    @if ($logs === null)
                        <div>
                            Log file >50M, please download it.
                        </div>
                    @else
                        <table class="table table-striped table-hover" cellspacing="0" id="table-log">
                            <thead>
                            <tr>
                                <th>Nivel</th>
                                <th>Contexto</th>

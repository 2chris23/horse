                                    ...
                                    <a class="image-popup-vertical-fit" title="Title Here 1"
                                       href="{!! $fotos->first()->getUrl()  !!}">--}}
                                        ...
                                        <img class="img-responsive"
                                             src="{!! $fotos->first()->getUrl()  !!}" alt="" style="margin: 0 auto;">
                                        {{--
        max-height: 300px;--}}
                                        {{--</a>--}}
                                    </div>
                        ...
                        <div class="col-xs-4 col-sm-4 col-md-4 m-t-25">
                            ...
                            {{--
                            <div class="porfolio-bottom m-t-20">
                                <ul class="portfolio-list">
                                    {{--<li class="portdetails">{!! trans('horse.text.name') !!}<span> {!! $nombre !!}</span></li>-- }}
                                    <li class="portdetails">{!! trans('horse.text.raza') !!}
                                        <span> {!! trans('horse.raza.'.$raza) !!}</span></li>
                                    <li class="portdetails">{!! trans('horse.text.sex') !!}
                                        <span> {!! trans('horse.sex.'.$sex) !!}</span></li>
                                    <li class="portdetails">{!! trans('horse.text.raised') !!} <span> {!! $raised !!}
                                            cm</span></li>
                                    <li class="portdetails">Edad
                                        <span> {!! $horse->getAge() !!} {!! trans('horse.years') !!}</span></li>
                                    <li class="portdetails">Capa <span> {!! $color !!}</span></li>
                                    <li class="portdetails">{!! trans('horse.text.doma') !!}
                                        <span> {!! trans('horse.doma.'.$doma) !!}</span></li>
                                    <li class="portdetails">{!! trans('horse.text.stud') !!}
                                        <span> {!!$yeguada !!}</span></li>
                                    @if($ParaVender !=false )
                                        <li class="portdetails">{!! trans('horse.text.price') !!}
                                            <span> {!! $precio !!}</span></li>
                                    @endif
                                </ul>
                            </div>
                            ...
                            <div class="col-xs-12 table-responsive">
                                ...
                                {{--
                                                                <div class="col-xs-12 m-t-10" style="padding-bottom: 20px">

    ...
    (function () {
        ...
        if (theme_vars.page_animations == 'on') {
            ...
            $("#site").animsition({
                ...
                loadingInner: '<img src="' + theme_vars.host + 'theme/0/images/audio.svg" alt="" />',
                timeout: false,
                ...
                transition: function (url) {
                    ...
                    $("#site").removeClass('fade-out').removeClass('fade-in');
                }
            });
        }
    })();
        ...
        if ($.fn.gmap3) {
            $('.gmap').each(function () {
                ...
                if (theme_vars.map_marker !== '') {
                    ...
                    marker = theme_vars.host + 'theme/0/images/map-marker.png';
                }
                var
                    gmap = $(this),

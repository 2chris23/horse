                ...
                <div class="row">
                    <div class="col-12 m-t-25">
                        <form action="" id="formulario" class="row">
                            ...
                            @include('backend.common.city',['city'=> $cliente->city ])ion--}}
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-xs-center">
                                <div class="form-group row">
                                    <label class="col-6 col-xs-6 col-xs-6 col-md-3 col-lg-3 col-form-label text-right">
                            ...
                            @foreach( $cliente->getPhoneModel() as $k => $v )
                                ...
                                'numero' => $v->getPhone(),
                                'nombre' => 'input_stud_phone[]', 'texto'  => trans('clientes.text.phone'), 'place' => trans('clientes.placeholder.phone'),
          'pais'  => $v->getCountryCode(), 'id'=>$v->id, ])
                            @endforeach

                            @if(count($cliente->getPhoneModel()) <5)
...
'exte'=>$v-getExt(),
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-10 col-sm-10 col-md-6">
                                    <input
id="input_cliente_google" type="text"
                                           placeholder="{{trans('stud.placeholder.google')}}"
                                           value="{{$cliente->getGoogle()->getUrl()}}" class="form-control">
                                </div>
                            </div>
                            --}}

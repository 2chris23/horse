...
<div style="width: 80%; margin: auto;">
    ...
    <p>
        Advertencia, las traducciones no son visibles hasta que se vuelven a exportar al archivo de la app/lang, usando
        el comando 'php artisan translation: export' o botón publicar.
    </p>
    <div class="alert alert-success success-import" style="display:none;">
        <p>Hecho importando, procesado <strong class="counter">N</strong> elementos! Recarga esta pagina para actualizar
            los grupos!</p>
    </div>
    <div class="alert alert-success success-find" style="display:none;">
        <p>Fianlizada la busqueda de traducciones, Encontrado <strong class="counter">N</strong> elementos!</p>
    </div>
    ...
    @if(!isset($group))
        ...
        <form class="form-inline form-find" method="POST"
            ...
            <input type="hidden" name="_token" value="{!! csrf_token(); !!}">
            <p></p>
            <button type="submit" class="btn btn-info" data-disable-with="Searching..">Encontrar traducciones en los
                archivos
            </button>
        </form>
        </p>
    ...
    @if(isset($group))
        <form class="form-inline form-publish" method="POST"
            ...
            <input type="hidden" name="_token" value="{!! csrf_token(); !!}">
            <button type="submit" class="btn btn-info" data-disable-with="Publishing..">Publicar las traducciones
            </button>
...
@endif
    ...
    @else
        <p>
            ...
            debes comprobar que has realizado las migraciones e importaciones de las traducciones.
        </p>

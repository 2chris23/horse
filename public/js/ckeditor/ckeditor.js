...
*/
    ...
    CKEDITOR.plugins.add("videodetector", {
        icons: "videodetector", init: function (a) {
    ...
    function switchMe(a, c) {
        var b = a.config.customConfig, i = a.config.contentCss, j = a.config.extraPlugins, d = a.config.smallToolbar,
            f = a.config.maximizedToolbar, g;
        g = a.config.toolbar == d ? f : d;
        var e = a.getData(), h = a.element.$;
        jQuery(h).val(e);
        e = h.id;
        a.destroy(!0);
        CKEDITOR.replace(e, {
    ...
    CKEDITOR.plugins.add("toolbarswitch", {
        requires: ["button", "toolbar", "maximize"], init: function (a) {
            var c = a.lang, b = a.addCommand("toolbarswitch", {
                exec: function (a) {
                    a.config.toolbar == a.config.maximizedToolbar ? (a.commands.maximize.exec(), switchMe(a, function (a) {
                        a.editor.fire("triggerResize")
                    })) : switchMe(a, function (a) {
                        a = a.editor;
                        a.commands.maximize.exec();
                        a.fire("triggerResize")
                    })
                }
            });
    ...
    (function () {
        ...
        if (CKEDITOR.env.hidpi) setIcons('bold,0,17px,italic,25,17px,strike,50,17px,subscript,75,17px,superscript,100,17px,underline,125,17px,blockquote,150,17px,copy-rtl,175,17px,copy,200,17px,cut-rtl,225,17px,cut,250,17px,paste-rtl,275,17px,paste,300,17px,horizontalrule,325,17px,image,350,17px,indent-rtl,375,17px,indent,400,17px,outdent-rtl,425,17px,outdent,450,17px,anchor-rtl,475,17px,anchor,500,17px,link,525,17px,unlink,550,17px,bulletedlist-rtl,575,17px,bulletedlist,600,17px,numberedlist-rtl,625,17px,numberedlist,650,17px,maximize,675,17px,pastetext-rtl,700,17px,pastetext,725,17px,pastefromword-rtl,750,17px,pastefromword,775,17px,removeformat,800,17px,source-rtl,825,17px,source,850,17px,specialchar,875,17px,scayt,900,17px,table,925,17px,redo-rtl,950,17px,redo,975,17px,undo-rtl,1000,17px,undo,1025,17px,spellchecker,1050,17px,icon_black,2150,auto,icon_white,2200,auto,toolbarswitch,1125,17px', 'icons_hidpi.png'); else setIcons('bold,0,auto,italic,42,auto,strike,84,auto,subscript,126,auto,superscript,168,auto,underline,210,auto,blockquote,252,auto,copy-rtl,294,auto,copy,336,auto,cut-rtl,378,auto,cut,420,auto,paste-rtl,462,auto,paste,504,auto,horizontalrule,546,auto,image,588,auto,indent-rtl,630,auto,indent,672,auto,outdent-rtl,714,auto,outdent,756,auto,anchor-rtl,798,auto,anchor,840,auto,link,882,auto,unlink,924,auto,bulletedlist-rtl,966,auto,bulletedlist,1008,auto,numberedlist-rtl,1050,auto,numberedlist,1092,auto,maximize,1134,auto,pastetext-rtl,1176,auto,pastetext,1218,auto,pastefromword-rtl,1260,auto,pastefromword,1302,auto,removeformat,1344,auto,source-rtl,1386,auto,source,1428,auto,specialchar,1470,auto,scayt,1512,auto,table,1554,auto,redo-rtl,1596,auto,redo,1638,auto,undo-rtl,1680,auto,undo,1722,auto,spellchecker,1764,auto,icon_black,1806,auto,icon_white,1848,auto,toolbarswitch,1890,auto', 'icons.png');
    })();

    ...
    <div class="container">
        <div class=" breadcrumb-link">
            <ul>
                ...
                --}}
                <li>
                    <a class="active" href="#">{!! trans('publicidad.titulo') !!}</a>
                </li>
            </ul>
        </div>
    </div>
            ...
            <div class="row">
                    ...
                    <div class="about-us-content">
                        <div class="heading-panel">
                            <h3 class="main-title text-left">
                                {!! trans('publicidad.publishpagecontenttitle') !!}
                            </h3>
                        </div>
                        <h2>
                        </h2>
                        {!! trans('publicidad.publishpagecontentcontent') !!}
                        {{--
                ...
                <div class="col-lg-6 col-md-6 col-sm-5 col-xs-12">
                    <div class="about-page-featured-image">
                        <a href="#">
                            <img src="{!! $imagen !!}" alt="{!! Config::get('app.name') !!} ">
                        </a>
                    </div>
                </div>
            </div>

                        ...
                        <td>
                            <table width="600" border="0" cellspacing="0" cellpadding="0" align="center"
                                ...
                                <tr>
                                    ...
                                    {{--
                                    <td width='225'>
                                        <div class="contentEditableContainer contentImageEditable fondo-boton">
                                            <div class="contentEditable">
                                                <img src="{!! $imagendia !!}" alt="image" width='225' height='225'
                                ...
                                <table width="600" border="0" cellspacing="0" cellpadding="0" align="center">
                                    <tr>
                                        @for($z = 0;$z<3;$z++)
                                            ...
                                            @if(!empty($work))
                                                <td width='190' height="320" class='bgItem'
                                                    style='border-radius:5px;-moz-border-radius:5px;-webkit-border-radius:5px;     padding-right: 10px;     '>


                                                    <table width="190" height="100%" border="0" cellspacing="0" cellpadding="0" align="center" class="grey-card" style="border: 1px solid #dedede;">
                                                        <tbody><tr>
                                                                    ...
                                                                    <div class="contentEditable">
                                                                        @if(!empty($imagen))
                                                                            <img src="{!! $imagen !!}" alt="image"
                                                                                 width='200'
                                                                                 height='150' class="imgs"
                                                                                 data-default="placeholder"
                                                                                 data-max-width="150"
                                                                                 data-max-height="150"
                                                                            >
                                                                        @else
                                                                            <table width="200" height="150" border="0" cellspacing="0"
                                                                                   cellpadding="0"
                                                                                   align="center"
                                                                            >
                                                                                <tr><td></td></tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td width="150" height="215" valign="top">
                                                                <div class="contentEditableContainer contentTextEditable">
                                                                    <div class="contentEditable">
                                            ...
                                            <table width="190" border="0" cellspacing="0" cellpadding="0" align="center"
                                                ...
                                                <tr>
                                                    ...
                                                    <td width='150' align="center">
                                                        <div class="contentEditableContainer contentImageEditable">
                                                            <div class="contentEditable">
                                                                <img src="{!! $fakeimg !!}" alt="image" width='100'
                                            ...
                                            <tr>
                                                ...
                                                <td width='68' align="center">
                                                    <div class="contentEditableContainer contentImageEditable grey-card noborderraduis">
                                                        <div class="contentEditable">
                                                            <img src="{!! url('logos/pinterest.png') !!}" alt="Pinterest" width='50'

...
<?php $__env->startSection('csstop'); ?>
    <?php 
        $web = trans('stud.photos');
        $web = (isset($web))?$web:trans('stud.photos');
...
<?php $__env->startSection('content'); ?>
    ...
    <?php echo $__env->make('frontend.landing.v6.partial.portfoliomasonStud',['fotos'=>1], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>

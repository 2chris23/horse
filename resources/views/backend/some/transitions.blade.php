...
<head>
    <meta charset="UTF-8">
    <title>Transitions | Admire</title>
    ...
    <link rel="stylesheet" type="text/css" href="css/pages/transitions.css" />
...
<!--Plugin scripts-->
<script type="text/javascript" src="vendors/Knob/js/jquery.knob.js"></script>
<!-- end of plugin scripts-->
<script type="text/javascript" src="js/pages/transitions-sliders.js"></script>

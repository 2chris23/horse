<?php
$etiquetalabel = "col-xs-12 col-sm-12 col-md-12 col-lg-3 text-sm-left text-md-left text-lg-right col-12";
$tiquetainput = "col-xs-12 col-sm-12 col-md-12 col-lg-8 col-12";
$pid = $stud->getFbcontact();
$time = \Session::get('timezone');
$time = !empty($time) ? $time : Request::cookie('timezone');

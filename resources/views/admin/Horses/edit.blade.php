...
<div class="col-12 m-t-25 row">
    ...
    <div class="col-2">
        <a class="btn btn-warning pull-right" href="{!! route('yeguadas.caballos',['id'=>$stud->id]) !!}">
            {!! trans('users.return') !!}
        </a>
    </div>
</div>
...
@section('bottomjs')
 ...
 .catch(function (error) {
        ...
        function savedata() {
            ...
            axios.post('{!! route('caballo.editarpost',['id'=>$horse->id]) !!}', form)
                .then(function (response) {
                    var r = response.data;
                    horse_id = r.id;
                    $('#horse_id').val(horse_id);
                    // FIXED: Removed duplicate photo upload trigger
                    // Photos are already uploaded via the form submission above

...
<head>
    ...
    <!--Page level styles-->
    <link type="text/css" rel="stylesheet" href="css/pages/sortable.css" />
                                        ...
                                        <div id="multi" class="row">
                                            <div class="col-lg-4 m-t-25">
                                                <div class="layer tile" data-force="30">
                                                    ...
                                                    <div class="tile__list">
                                                        <img src="img/authors/avatar.jpg" alt="image" />
                                                        <img src="img/roundicons/flat/Food-19.png" alt="image"/>
                                                        <img src="img/roundicons/flat/Technology-10.png" alt="image"/>
                                                        <img src="img/gallery/full/1.jpg" alt="image"/>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-4 m-t-25">
                                            ...
                                            <div class="col-lg-4 m-t-25">
                                                <div class="layer tile" data-force="20">
                                                    ...
                                                    <div class="tile__list">
                                                        <img src="img/authors/avatar7.jpg" alt="image"/>
                                                        <img src="img/authors/avatar.jpg" alt="image"/>
                                                    </div>
                                                </div>
                                            </div>
...
<!--Plugin scripts-->
<script type="text/javascript" src="vendors/sortable/js/Sortable.min.js"></script>
<script type="text/javascript" src="vendors/slimscroll/js/jquery.slimscroll.min.js"></script>
<!--End of Plugin scripts-->
<!--Page level scripts-->
<script type="text/javascript" src="js/pages/sortable.js"></script>

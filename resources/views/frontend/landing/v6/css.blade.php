<?php if(!empty($stud)): ?>
    ...
    <?php if(empty($stud)): ?>
        <style>
            ...
            .flex-direction-nav .flex-prev {
                opacity: 0;
                right: 0;
                cursor: url(<?php echo url('theme/g/images/prev-light.png'); ?>), e-resize;
            }
            ...
            .flex-direction-nav .flex-next {
                ...
                cursor: url(<?php echo url('theme/g/images/next-light.png'); ?> ), e-resize;
            }
            ...
            */
            ...
            .icon-social:before, .icon-social:after {
            ...
            <?php if(!empty($colorcorp)): ?>
              
            .footer .footer-social-links i:hover,
            .ib:hover,
            .btn:focus,
            .fa-play:hover,
            .post-columns .post-title a:hover,
            .post-more a:hover {
                color: <?php echo $colorcorp; ?>      !important;
            }

            .btn {
                color: <?php echo $colorcorp; ?>;
                border: 1px solid<?php echo $colorcorp; ?>;
            }
            ...
            .btn:hover,
            .scroll-up a:hover {
                background: <?php echo $colorcorp; ?>          !important;
                color: #fff !important;
            }

            
      .works-grid.works-hover-g .work-item:hover .work-image:after {
                background: <?php echo $colorcorp; ?>;
                background: linear-gradient(135deg,
                rgba(<?php echo Funciones::Hex2Rgba($colorcorp,"0.1"); ?>) 0%,
                rgba(<?php echo Funciones::Hex2Rgba($colorcorp,"0.9"); ?>) 100%);
                filter: progid:DXImageTransform.Microsoft.gradient(startColorstr='#6fe29e', endColorstr='#5bdad1', GradientType=1);
                opacity: 1;
            }
    ...
    .post-columns .post {
            ...
            .showcase-page .module .container .row {
                margin-right: 0;
            }
            ...
            select, textarea, input[type="text"], input[type="url"], input[type="tel"], input[type="email"], input[type="search"], input[type="number"], input[type="date"] {
   ...
   width: 60px;
        ...
        .jssocials-share-<?php echo $k; ?> a,
            .jssocials-share-<?php echo $k; ?> a:hover {
        ...
        .jssocials-share-twitter a:hover,
            ...
            .jssocials-shares > div:hover {
            


            }

            #SocialShare a .fa:hover {
                font-size: 30px;

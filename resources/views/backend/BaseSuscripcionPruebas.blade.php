        ...
        <div class="c-stickynav js-index-menu col-12" id="hw-menu">
            <div class="row text-center justify-content-center scrollmenu" style="position: relative;">
                <ul class="nav" id="index-menu">
                    ...
                    --}}
                    <li class="nav-item col-menu js-limited js-menu-single uppercase ">
                        <a class="nav-link" data-toggle="tab" href="#resu" role="tab" aria-controls="resu">
                            RESUMEN
                        </a>
                    </li>
                    {{--
...
(no hacer por ahora)
                    ...
                    --}}
                    <li class="nav-item col-menu js-limited js-menu-single uppercase ">
                        <a class="nav-link" data-toggle="tab" href="#plan" role="tab" aria-controls="plan">
                            PLANES
                        </a>
                    </li>
                    <li class="nav-item col-menu js-ss17 js-menu-single uppercase">
                        <a class="nav-link" data-toggle="tab" href="#patro" role="tab" aria-controls="patro">
                            PLAN PATROCINIO

                        </a>
                    </li>
                    <li class="nav-item col-menu js-original js-menu-single uppercase">
                        <a class="nav-link" data-toggle="tab" href="#otro" role="tab" aria-controls="otro">
                            OTROS PRODUCTOS </a>
                    </li>
                    <li class="nav-item  col-menu js-kids js-menu-single uppercase" aria-controls="sopor">
                        <a class="nav-link" data-toggle="tab" href="#sopor" role="tab">
                            SOPORTE</a>
                    </li>
                    {{--}}
                    <li class="col-menu fresh js-fresh js-menu-single uppercase" style="">
                        <a href="/collections/deals-sunglasses">Offers</a>
                    </li>
                    --}}
                </ul>
            </div>
    ...
    <div class="col-12 col-md-12 col-lg-12 offset-xl-1 col-xl-10 m-t-35 text-center ">
        ...
        <div class="row wrap  " id="resu2" >
            <div class="col-12 row">
                Resumen move<br><br><br><br><br><br><br><br><br><br>
            </div>
        </div>
        ...
        <div class="row wrap  " id="patro2" >
            <div class="col-12 row">
                patrocinio move<br><br><br><br><br><br><br><br><br><br>
            </div>
        </div>
        <div class="row wrap  " id="otro2" >
            <div class="col-12 row">
                otro move<br><br><br><br><br><br><br><br><br><br>
            </div>
        </div>
        <div class="row wrap  " id="sopor2" >
            <div class="col-12 row">
                soporte move<br><br><br><br><br><br><br><br><br><br>
            </div>
        </div>
    </div>
    {{--
    ...
    <div class="col-12 col-md-12 col-lg-12 offset-xl-1 col-xl-10 m-t-35 text-center tab-content ">

        <div class="row wrap tab-pane fade" id="resu" role="tabpanel">
            <div class="col-12 row">
                Resumen
            </div>
        </div>

        <div class="wrap tab-pane fade show  active" id="plan" role="tabpanel">
            <div class="main packets">
                @foreach($plan as $k=>$v)
        ...
        <div class="row wrap tab-pane fade" id="patro" role="tabpanel">
            <div class="col-12 row">
                patrocinio
            </div>
        </div>
        <div class="row wrap tab-pane fade" id="otro" role="tabpanel">
            <div class="col-12 row">
                otro
            </div>
        </div>
        <div class="row wrap tab-pane fade" id="sopor" role="tabpanel">
            <div class="col-12 row">
                soporte
            </div>
        </div>

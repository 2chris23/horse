...
<head>
    ...
    <!--Plugin styles-->
    <link type="text/css" rel="stylesheet" href="vendors/ion-rangeslider/css/ion.rangeSlider.skinFlat.css" />
    <link type="text/css" rel="stylesheet" href="vendors/ion-rangeslider/css/ion.rangeSlider.css" />
    <link type="text/css" rel="stylesheet" href="vendors/bootstrap-slider/css/bootstrap-slider.min.css" />
    <!--End of plugin styles-->
    <!--Page level styles-->
    <link type="text/css" rel="stylesheet" href="css/pages/slider_ion.css" />
...
<!--Plugin scripts-->
<script type="text/javascript" src="vendors/ion-rangeslider/js/ion.rangeSlider.min.js"></script>
<script type="text/javascript" src="vendors/bootstrap-slider/js/bootstrap-slider.js"></script>
<script type="text/javascript" src="vendors/select2/js/select2.js"></script>
<!--End of plugin scripts-->
<!--Page level scripts-->
<script type="text/javascript" src="js/pages/sliders.js"></script>

(function ($) {
    ...
    var ccll= $(".slider-active").owlCarousel({
        items: 1,
    ...
    /*
    var element = document.querySelector('.owl-prev'), events = $._data(element, "events");
var element =  document.querySelector('.slider-active');
    var target = document.querySelector('.owl-prev');
    var events = $._data(element, "events");;
    var events2 = $._data(target, "events");;

    for ( var type in events ) {
        for ( var handler in events[ type ] ) {
            $.event.add( target, type, events[ type ][ handler ], events[ type ][ handler ].data );
        }
    }

    //var element = document.querySelector('.owl-prev'),  list_of_events = function($._data(element, "events")){console.log(list_of_events);};
    element = document.querySelector('.slider-active')
    $.get('.owl-nav',function (e) {
        $(e).copyEvents('.slider-active')
    })
    $('.owl-nav').on(event,function(event){console.dir(event);});
//.slider-active
    */
    /*
    original

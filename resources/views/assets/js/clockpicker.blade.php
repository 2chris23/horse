...
@if(!empty($cd))
    <script>
            ...
            function s(s, r) {
                function p(t, i) {
                    var e = u.offset(), s = /^touch/.test(t.type), o = e.left + b, n = e.top + b,
                        ...
                        h = (s ? t.originalEvent.touches[0] : t).pageY - n, k = Math.sqrt(p * p + h * h), v = !1;
                    if (!i || !(g - y > k || k > g + y)) {
                        t.preventDefault();
                ...
                var h = n(V), u = h.find(".clockpicker-plate"), v = h.find(".clockpicker-hours"),
                    ...
                    C = "INPUT" === s.prop("tagName"), H = C ? s : s.find("input"), P = s.find(".input-group-addon"),
                    x = this;
        ...
        var c, n = window.jQuery, r = n(window), a = n(document), p = "http://www.w3.org/2000/svg",
            ...
            v = navigator.vibrate ? "vibrate" : navigator.webkitVibrate ? "webkitVibrate" : null, m = 0, b = 100,
            g = 80, w = 54, y = 13, M = 2 * b, A = h ? 350 : 1,
        ...
        s.DEFAULTS = {
            ...
            if (!this.isShown) {
                ...
                s.prototype.hide = function () {
                    ...
                    var s = "hours" === t, c = s ? this.hoursView : this.minutesView,

...
------------------------- --}}
        ...
        .tab-product-area .owl-item {
            height: 245px;
        }

        .featured-product .pro-image,
        .tab-product-area .pro-image {
            height: 190px;
        }

        .featured-product .product-item,
        .tab-product-area .product-item,
        .tab-product-area .single-product-item {
            height: 245px;

        }

        .featured-product .product-img-hover,
        .tab-product-area .product-img-hover {
            position: relative;
            height: 173px;
        }

        .featured-product .pro-name-price-ratting,
        .tab-product-area .pro-name-price-ratting {
            position: absolute;
            top: 200px;
            padding-bottom: 36px;
        }

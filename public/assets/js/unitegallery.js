...
function UGFunctions() {
    ...
    this.debugVar = "", this.z__________FULL_SCREEN___________ = function () {
        ...
        if (!n) var n = 1.2;
        if (!o) var o = "fit";
        var l, u, d, _, g = n, c = e.parent(), h = i.getElementSize(e), p = i.getImageOriginalSize(e), f = !1, m = 0,
            v = 0, b = 0, y = 0;
        if (r) {
        ...
        var u = i.getImageInsideParentData(null, t, n, a, null, r, o), d = r, _ = o, g = u.imageLeft, c = u.imageLeft,
            h = u.imageTop, p = u.imageTop, f = Math.round((l.width - r) / 2), m = Math.round((l.height - o) / 2),
            v = u.imageWidth + g + c, b = r - v;
        0 != b && (c += b);
        ...
        var o = i.getMousePosition(e), a = jQuery.now(), s = {
            startTime: a,
            lastTime: a,
            startMouseX: o.pageX,
            startMouseY: o.pageY,
...
function UGThumbsGeneral() {
    function e(e, t, i, n) {
        var r = {width: e + "px", height: t + "px"},
            o = {width: e - j.thumbInnerReduce + "px", height: t - j.thumbInnerReduce + "px"},
    ...
    function i(e, t, i) {
        var n = e.children(".ug-thumb-overlay"), r = x.thumb_transition_duration;
        i && i === !0 && (r = 0), t ? n.stop(!0).fadeTo(r, j.colorOverlayOpacity) : n.stop(!0).fadeTo(r, 0)
    }

    function n(e, t, i) {
        var n = e.children("img.ug-thumb-image"), r = e.children("img.ug-thumb-image-overlay"),
    ...
    function a() {
        ...
        var e = {"border-radius": x.thumb_round_corners_radius + "px"};
        w.find(".ug-thumb-wrapper, .ug-thumb-wrapper .ug-thumb-border-overlay").css(e)
    }

    function s(e, t) {
        e.stop(!0).animate(t, {duration: x.thumb_transition_duration, easing: x.thumb_transition_easing, queue: !1})
    }
    ...
    function u(t, i, n) {
        if (1 == x.thumb_fixed_size) P.scaleImageCoverParent(i, t); else {
    ...
    function _() {
        var e = "", t = x.thumb_image_overlay_type.split(",");
        for (var i in t) {
            var n = t[i];
            switch (n) {
                case"bw":
    ...
    var v, b, y, I, w, E = this, T = jQuery(E), S = new UniteGalleryMain, P = new UGFunctions;
    this.events = {
    ...
    this.init = function (e, t) {
        ...
        for (var n = 0; t > n; n++) {
            ...
            var a = r.index + 1, s = "style='z-index:" + a + ";'",
        ...
        var e = {width: x.thumb_width, height: x.thumb_height};
        return e
...
function UGThumbsStrip() {
    ...
    function o() {
        var e = C.children(".ug-thumb-wrapper"), t = jQuery(e[0]), i = t.outerWidth(), n = t.outerHeight(),
            o = N.getOptions();
    ...
    var T, S, P, x, j, C, A, M, O = this, z = new UniteGalleryMain, L = new UGFunctions, H = !1,
        N = new UGThumbsGeneral, L = new UGFunctions, k = {
    ...
    this.setHtml = function (e) {
        ...
        if (0 == H) var r = n + G.stripSize, o = i.left, a = i.left + t.width(); else var r = n + G.stripSize,
            o = i.top, a = i.top + t.height();
        var s = !1;
        ...
        var e = N.getOptions(), t = jQuery.extend(k, e), i = {
            g_gallery: z,
            g_objGallery: T,
            g_objWrapper: P,
            g_arrItems: x,
...
function UGTouchThumbsControl() {
    ...
    function a() {
        var e = E.thumb_touch_slowFactor, t = E.minDeltaTime, i = E.minPath, n = h.getInnerStripPos(), r = jQuery.now(),
            o = r - T.lastTime, a = n - T.lastPortionPos;
        t > o && T.lastDeltaTime > 0 && (o = T.lastDeltaTime, a = T.lastDeltaPos + a), t > o && (o = t);
        var l = a > 0 ? 1 : -1, u = 0;
        o > 0 && (u = a / o);
        var d = u * u / (2 * e) * l;
        Math.abs(d) <= i && (d = 0);
        var _ = h.getInnerStripPos(), g = _ + d, c = h.fixInnerStripLimits(g), p = h.getInnerStripLimits(),
            f = E.limitsBreakAddition, m = !1, v = c;
    ...
    var h, p, f, m, v, b, y, I, w = new UGFunctions, E = {
...
function UGStripPanel() {
    ...
    var m, v, b, y, I, w = this, E = jQuery(this), T = new UniteGalleryMain, S = new UGFunctions, P = new UGThumbsStrip,
        x = new UGPanelsBase;
...
function UGGridPanel() {
    ...
    var I, w, E, T, S = this, P = jQuery(this), x = new UniteGalleryMain, j = new UGFunctions, C = new UGThumbsGrid,
        A = new UGPanelsBase;
    this.events = {FINISH_MOVE: "gridpanel_move_finish", OPEN_PANEL: "open_panel", CLOSE_PANEL: "close_panel"};
    var M = {
        ...
        z = {gridpanel_grid_align: "center"}, L = {
            panelType: "grid",
            isHorType: !1,
            arrowsVisible: !1,
            panelHeight: 0,
...
function UGThumbsGrid() {
    ...
    function a() {
        ...
        var e = !1, t = F.isMobileMode(), i = X.spaceBetweenCols;
        ...
        var n = o(), r = n.width, a = X.tileMaxWidth,
    ...
    function s() {
        var e = o(), t = e.height, i = X.gridWidth,
    ...
    function l() {
        var e = o(), t = e.width,
            i = V.grid_num_cols * t + (V.grid_num_cols - 1) * X.spaceBetweenCols + 2 * V.grid_padding, n = X.gridHeight;
    ...
    function h() {
        var e = D.children(".ug-thumb-wrapper"), t = V.grid_padding, n = V.grid_padding, r = n, o = t, a = 0, s = 0,
            l = 0, u = 0, d = 0;
    ...
    function S() {
        ...
        var e = B.getStoredEventData(X.storedEventID), t = e.diffTime, i = E(), n = Math.abs(i - e.startInnerPos);
        return n > 30 ? !0 : n > 5 && t > 300 ? !0 : !1
    }

    function P() {
        var e = B.getStoredEventData(X.storedEventID), t = E();
    ...
    function M(e) {
        ...
        var t = B.getStoredEventData(X.storedEventID, X.isNavigationVertical), i = A();
        if (i) return !0;
    ...
    var H, N, k, R, G, D, Q = this, W = jQuery(this), F = new UniteGalleryMain, B = new UGFunctions,
        Y = new UGThumbsGeneral, U = new UGTileDesign, V = {
    ...
    this.destroy = function () {
        ...
        var n = Y.getNumThumbs(), r = Math.ceil(n / V.grid_num_cols), o = r * t + (r - 1) * X.spaceBetweenRows,
            a = Math.ceil(o / e);
        return a
    }, this.getNumPanesEstimationByWidth = function (e) {
        if (X.isTilesMode) var t = V.tile_width; else var i = Y.getOptions(), t = i.thumb_width;
        var n = Y.getNumThumbs(), r = Math.ceil(n / V.grid_num_rows), o = r * t + (r - 1) * X.spaceBetweenCols,
            a = Math.ceil(o / e);
        return a
    }, this.getHeightEstimationByWidth = function (e) {
        if (0 == X.isTilesMode) throw new Error("This function works only with tiles mode");
        var t = Y.getNumThumbs(), i = B.getNumItemsInSpace(e, V.tile_width, X.spaceBetweenCols), n = Math.ceil(t / i);
...
function UGTiles() {
    ...
    function h(e, t) {
        ...
        var n = e.index(), r = oe.getColByIndex(le.numCols, n), o = re.getItem(n);
        ae.resizeTile(e, le.colWidth), _(e, !0, !0, r), o.ordered_placed = !0;
        var a = re.getNumItems(), s = oe.getNextRowSameColIndex(n, le.numCols);
        if (s >= a) return !1;
        var l = se.getThumbByIndex(s), u = re.getItem(s);
        se.isThumbLoaded(l);
    ...
    function f() {
        ...
        if (1 == ue.tiles_set_initial_height && 0 == oe.isScrollbarExists() && 25 > t) {
            var i = (e.length, Math.ceil(e.length / le.numCols)), r = i * ue.tiles_col_width * .75;
            J.height(r), u()
        }
        e.fadeTo(0, 0);
        ...
        if (1 == de.isFixedMode) ne.trigger(ie.events.TILES_FIRST_PLACED), g(!0), oe.checkImagesLoaded(o, function () {
            ...
            var a = le.numCols, s = le.galleryWidth, l = !1;
    ...
    function m() {
        var e = r(), t = se.getThumbs(), i = ue.tiles_justified_row_height, n = [], o = 0,
            a = ue.tiles_justified_space_between, s = t.length;
        jQuery.each(t, function (e, t) {
            t = jQuery(t);
            var r = se.getItemByThumb(t), a = r.thumbWidth, s = r.thumbHeight;
    ...
    function b() {
        var e = jQuery(K).find("img.ug-thumb-image"), t = se.getThumbs();
    ...
    function E(e) {
        var t, i, n = {}, r = _e.colWidth, o = _e.currentGap, a = ae.getTileImageSize(e), s = e.index(),
            l = Math.ceil(T(s) * (1 * _e.nestedOptimalCols / 3) + 2 * _e.nestedOptimalCols / 3), u = a.width,
            d = a.height, _ = u / d;
    ...
    function x(e, t) {
        ...
        for (var i = oe.getObjectLength(ee), n = _e.gridY; i + 1 >= n; n++) {
            for (var r = 0; r < _e.maxColumns; r++) if (0 == D(_e.gridY) || 0 == F(_e.gridY, r)) {
                var o = G(r);
                return void j(e, o, r)
            }
            _e.gridY++
    ...
    function j(e, t, i) {
        var n = jQuery.extend(!0, {}, te[e]), r = n.dimWidth, o = t - n.dimWidth, a = _e.nestedOptimalCols,
            s = t <= n.dimWidth || .33 * a >= o || a >= t;
        if (s) H(e, t); else if (a >= o) a >= 4 ? 1 == R(Math.floor(t / 2), i) ? H(e, Math.floor(t / 2) + 1) : H(e, Math.floor(t / 2)) : H(objImage, t); else if (1 == R(r, i)) switch (r >= a) {
            case!0:
                H(e, r - 1);
                break;
            case!1:
    ...
    function A(e, t, i) {
        var n = te[e], r = n.dimHeight, o = (n.dimWidth, n.left), a = n.top,
    ...
    function O(e, t) {
        ...
        for (var _ = n, g = [], s = r.length - 1; s >= 0; s--) {
            ...
            0 != s ? (c = Math.max(Math.round(1 * n / 3), Math.floor(r[s][1] * (n / i))), _ -= c, d = N(l, c, !0), d.left = o, d.top = a, g.push({
                tileID: l,
                sizes: d
            }), a += d.dimHeight) : (c = _, d = N(l, c, !0), d.left = o, d.top = a, g.push({tileID: l, sizes: d}))
        }
        return g
    }

    function z(e, t, i) {
        var n = _e.gridY - 1, r = 0, o = 0, a = 1, s = [], l = [];
        if (s.push(e), n >= 0) {
            for (o = 0; n >= 0;) {
    ...
    function L(e, t) {
        var i = 0, n = 0, r = t.dimWidth, o = t.dimHeight, a = 0, s = 0, l = jQuery.map(ee, function (e, t) {
            return [e]
        });
        if ("undefined" == typeof l[_e.gridY] || "undefined" == typeof l[_e.gridY][e - 1]) n = 0; else for (var u = 0; ;) {
            if ("undefined" == typeof ee[_e.gridY + u] || -1 == ee[_e.gridY + u][e - 1]) break;
            a = ee[_e.gridY + u][e - 2], u++, n++
        }
        if ("undefined" == typeof l[_e.gridY] || "undefined" == typeof l[_e.gridY][e + r]) i = 0; else for (u = 0; ;) {
    ...
    function H(e, t, i) {
        i || (i = !1);
        var n = _e.colWidth, r = _e.currentGap, o = te[e], a = o.imgWidth, s = o.imgHeight, l = a / s;
    ...
    function N(e, t, i) {
        i || (i = !1);
        var n = te[e], r = n.dimWidth, o = _e.colWidth, a = _e.currentGap;
        if (1 == i) {
    ...
    function G(e) {
        var t = e, i = 0;
        if (1 == D(_e.gridY)) for (; 0 == F(_e.gridY, t);) i++, t++; else i = _e.maxColumns;
        return i
    }
    ...
    function Q(e, t, i, n) {
        for (var r = 0; r < t.dimHeight; r++) for (var o = 0; o < t.dimWidth; o++) 0 == D(n + r) && W(n + r), B(n + r, i + o, e)
    }
    ...
    function U(e, t) {
        var i = se.getThumbByIndex(e), n = te[e], r = n.top * (_e.colWidth + _e.currentGap),
    ...
    var q, K, J, $, ee, te, ie = this, ne = jQuery(this), re = new UniteGalleryMain, oe = new UGFunctions,
        ae = new UGTileDesign, se = new UGThumbsGeneral, le = {}, ue = {
            tiles_type: "columns",
            tiles_col_width: 250,
            tiles_align: "center",
            tiles_exact_width: !1,
    ...
    var de = {isFixedMode: !1, isFirstTimeRun: !0, handle: null, isTransActive: !1, isTransInited: !1, isAllLoaded: !1},
        _e = {
            colWidth: null,
            nestedOptimalCols: 5,
            gridY: 0,
...
function UGTileDesign() {
    ...
    function n(e, t) {
        ...
        if (F.tile_enable_icons) {
            ...
            if (t.link && 1 == F.tile_show_link_icon || 1 == F.tile_as_link) if (0 == F.tile_as_link) {
                var u = "";
        ...
        if (1 == F.tile_enable_image_effect) {
            ...
            var f = "<div class='ug-tile-image-overlay" + p + "' >", m = " ug-" + F.tile_image_effect_type + "-effect";
    ...
    function b(e, t, i, n) {
        ...
        if (0 == F.tile_enable_image_effect) Q.scaleImageCoverParent(l, t, i), 0 == Y.hasImageContainer && null !== d && Q.placeElement(l, 0, d); else {
            var h = "nothing";
    ...
    function y(e, t, i, n) {
        ...
        if (_) if (1 == Y.isTextpanelOutside && n && "bottom" == F.tile_textpanel_position) {
            var c = n - d;
            s.positionPanel(c)
    ...
    function I(e) {
        ...
        if (t && i) {
            var m = Q.getElementSize(t), v = Q.getElementSize(i), I = F.tile_space_between_icons,
                w = m.width + I + v.width, E = Math.floor((n.width - w) / 2);
    ...
    function w(e, t) {
        var i = (R.getItemByTile(e), r(e)), n = F.thumb_transition_duration;
    ...
    function E(e, t) {
        var i = F.thumb_transition_duration, n = d(e);
        if (!n) return !0;
    ...
    function S(e, t) {
        if (t = jQuery(t), F.tile_enable_image_effect && w(t, !0), 1 == F.tile_enable_textpanel && 0 == F.tile_textpanel_always_on && 0 == Y.isTextPanelHidden && E(t, !0), Y.isSaparateIcons && 1 == F.tile_enable_icons) {
            var i = 1 == F.thumb_overlay_reverse, n = R.getItemByTile(t);
            0 == v(n) && T(t, i, !1)
        }
    }
    ...
    function P(e, t) {
        if (t = jQuery(t), F.tile_enable_image_effect && w(t, !1), 1 == F.tile_enable_textpanel && 0 == F.tile_textpanel_always_on && E(t, !1), 1 == Y.isSaparateIcons && 1 == F.tile_enable_icons) {
            var i = 1 == F.thumb_overlay_reverse ? !1 : !0, n = R.getItemByTile(t);
    ...
    this.loadTileImage = function (e) {
        ...
        } else var t = F.tile_width, i = F.tile_height;
...
function UGSlider() {
    ...
    function h(e, t) {
        var i = Se.slider_video_constantsize_width, n = Se.slider_video_constantsize_height,
    ...
    function p(e, t, i) {
        ...
        if (objPadding = pe.getObjImagePadding(), a == o && i !== !0) {
            ...
            e.fadeTo(0, 1);
            var i = e.parent().parent(), n = pe.getSlideType(i), r = J(i), o = pe.getObjImagePadding(),
                a = pe.getScaleMode(i);
    ...
    function T(e, t) {
        ...
        var s = Se.slider_transition_speed, u = Se.slider_transition_easing, d = {
            duration: s, easing: u, queue: !1, always: function () {
    ...
    var te, ie, ne, re, oe, ae, se, le, ue, de, _e, ge, ce, he, pe = this, fe = jQuery(pe), me = new UniteGalleryMain,
        ve = null, be = null, ye = null, Ie = new UGVideoPlayer, we = new UGFunctions, Ee = null, Te = null;
    this.events = {
    ...
    this.switchSlideNums = function (e) {
        ...
        var e = pe.getSlidesReference(), t = we.getElementSize(e.objCurrentSlide), i = -t.left,
        ...
        var e = pe.getSlidesReference(), t = e.objCurrentSlide.data("index"), i = me.getPrevItem(t),
            n = me.getNextItem(t);
        ...
        var t = pe.getScaleMode(), i = pe.getObjImagePadding(), n = ee(), r = e.parent(),
            o = we.getImageInsideParentData(r, n.imageWidth, n.imageHeight, t, i), a = we.getElementSize(e), s = !1;
        ...
        var o = e - Se.slider_item_padding_left - Se.slider_item_padding_right,
            s = t - Se.slider_item_padding_top - Se.slider_item_padding_bottom, d = {};
...
function UGTextPanel() {
    function e(e, t) {
        ...
        if (d) {
            ...
            var o = f.getElementSize(d), i = o.bottom
        }
        var a = "";
    ...
    var l, u, d, _, g, c, h, p = this, f = new UGFunctions, m = "", v = {
        ...
        textpanel_bg_css: {}
    }, b = {isFirstTime: !0, setInternalHeight: !0};
...
function UGBullets() {
    ...
    var o, a, s, l = this, u = 0, d = new UniteGalleryMain, _ = -1, g = new UGFunctions, c = {isInited: !1},
...
function UGProgressBar() {
    var e, t, i = this, n = 0, r = new UGFunctions,
...
function UGProgressPie() {
    ...
    var t, i, n = this, r = !1, o = new UGFunctions, a = {
...
function UGTouchSliderControl() {
    ...
    function r() {
        ...
        1 == a ? i(t) : h.stop().animate({left: l + "px"}, {
    ...
    var c, h, p, f, m = new UGSlider, v = new UGFunctions, f = {
    ...
    this.isTapEventOccured = function (t) {
        ...
        b.lastNumTouches = n;
        var r = m.getSlidesReference(), o = (e(r), Math.abs(b.lastMouseX - b.startMouseX)),
            a = Math.abs(b.lastMouseY - b.startMouseY), s = jQuery.now(), l = s - b.startTime;
...
function UGZoomSliderControl() {
    ...
    function s(e) {
        ...
        var t = T.getMousePosition(e), i = (t.pageX - P.startMouseX, t.pageY - P.startMouseY, t.pageX - P.lastMouseX),
            n = t.pageY - P.lastMouseY, r = 0 > i ? "left" : "right", o = 0 > n ? "up" : "down";
    ...
    function l() {
        var e = !1, t = !1, i = 0, n = 0, r = T.getElementSize(P.objImage), o = E.getObjImagePadding(),
    ...
    function c(e) {
        var t = T.getArrTouches(e), i = T.getDistance(t[0].pageX, t[0].pageY, t[1].pageX, t[1].pageY),
            n = i / P.startDistance, r = T.getMiddlePoint(t[0].pageX, t[0].pageY, t[1].pageX, t[1].pageY),
            o = P.objImageSize.width * n, a = P.objImageSize.height * n, s = T.getImageOriginalSize(P.objImage), l = 1;
        ...
        var u = r.x - P.startMiddlePoint.x, d = r.y - P.startMiddlePoint.y, _ = P.startImageX + panX + u,
    ...
    var y, I, w, E = new UGSlider, T = new UGFunctions, S = {
...
function UGVideoPlayer() {
    ...
    var a, s, l, u, d, _, g, c, h = this, p = jQuery(this), f = new UGFunctions, m = new UGYoutubeAPI,
        v = new UGVimeoAPI, b = new UGHtml5MediaAPI, y = new UGSoundCloudAPI, I = new UGWistiaAPI, w = null,
...
function UniteGalleryMain() {
    ...
    function fillItemsArray(e) {
        ...
        for (var i = t.isMobileMode(), n = 0, r = 0; r < e.length; r++) {
            var o = jQuery(e[r]), a = o.prop("tagName").toLowerCase(), s = "";
            if ("a" == a) {
            ...
            if (u.type = l, "img" == a) {
                ...
                var _ = o.data("image"), g = o.data("thumb");
            ...
            var f = o.data("width"), m = o.data("height");
            ...
            var v = void 0 == u.urlImage || "" == u.urlImage, b = void 0 == u.urlThumb || "" == u.urlThumb;
            switch (u.type) {
                case"youtube":
    ...
    var t = this, g_galleryID, g_objGallery = jQuery(t), g_objWrapper, g_objParent, g_objThumbs, g_objSlider,
        g_functions = new UGFunctions, g_objTabs, g_arrItems = [], g_numItems, g_selectedItem = null,
        g_selectedItemIndex = -1, g_objTheme, g_objCache = {};
    this.events = {
    ...
    this.onItemBigImageLoaded = function (e, t) {
        ...
        jQuery.ajax({
            type: "post", url: g_options.gallery_urlajax, dataType: "json", data: a, success: function (e) {
        ...
        if (n || (n = e), 1 == i && (r = !1), 1 == r && g_objCache.hasOwnProperty(n)) {
            var o = g_objCache[n];
            t.changeItems(o, n)
        } else g_objGallery.trigger(t.events.GALLERY_BEFORE_REQUEST_ITEMS), t.ajaxRequest("front_get_cat_items", {catid: e}, !0, function (e) {
            var i = e.html;
            t.changeItems(i, n)
        })
...
function UGLightbox() {
    ...
    function c(e, t) {
        ...
        if (Z.show(), q.show(), se.positionFrom = "positionArrowsInside", 1 == se.isArrowsOnHoverMode && 1 == i && 0 == y() && I(!0), 0 == i) var n = re.getElementRelativePos(Z, "left", ae.lightbox_arrows_offset),
            ...
            o = re.getElementRelativePos(q, "right", ae.lightbox_arrows_offset), a = r; else var s = ne.getSlideImage(),
            ...
            o = re.getElementRelativePos(Z, "right", 0, s) + l.left - ae.lightbox_arrows_inside_offset, a = r;
        if (t === !0) {
    ...
    function h(e, t) {
        ...
        if (0 == i) var o = n, a = r; else {
            var s = ne.getSlideImage(), l = re.getElementSize(s), u = re.getElementSize(ne.getElement()),
    ...
    var U, V, X, Z, q, K, J, $, ee = this, te = jQuery(this), ie = new UniteGalleryMain, ne = new UGSlider,
        re = new UGFunctions, oe = new UGTextPanel, ae = {
            lightbox_type: "wide",
...
function UGCarousel() {
    ...
    function c() {
        var e = F.getElementSize(R), t = F.getElementSize(G), i = t.width - e.width + t.left, n = V.sideSpace - i;
        return n
    }
    ...
    function w(e, t, i) {
        ...
        var n = u(e), r = F.getElementSize(n), o = -r.left + U.carousel_padding, a = {left: o + "px"};
        if (t === !0) {
    ...
    function E() {
        var e = -r(), t = s(e), i = F.getElementSize(u(t)).left, n = F.getElementSize(u(t + 1)).left;
    ...
    function C(e) {
        ...
        V.lastMousePos = o(e);
        var i = V.lastMousePos - V.startMousePos, n = V.startInnerPos + i, r = i > 0 ? "prev" : "next",
    ...
    var H, N, k, R, G, D = this, Q = jQuery(this), W = new UniteGalleryMain, F = new UGFunctions, B = new UGTileDesign,
        Y = new UGThumbsGeneral, U = {
            carousel_padding: 8,
...
!function (e) {
    ...
    var i = Math.pow, n = Math.sqrt, r = Math.sin, o = Math.cos, a = Math.PI, s = 1.70158, l = 1.525 * s, u = s + 1,
        d = 2 * a / 3, _ = 2 * a / 4.5;
    e.extend(e.easing, {
    ...
    var o,
        ...
        }, _ = {"byte": {floor: !0, max: 255}, percent: {max: 1}, degrees: {mod: 360, floor: !0}}, g = u.support = {},
        c = e("<p>")[0], h = e.each;
    c.style.cssText = "background-color:rgba(1,1,1,.5)", g.rgba = c.style.backgroundColor.indexOf("rgba") > -1, h(d, function (e, t) {
        ...
        parse: function (r, a, s, l) {
            ...
            var n = u(e), r = n._space(), o = d[r], a = 0 === this.alpha() ? u("transparent") : this,
                s = a[o.cache] || o.to(a._rgba), l = s.slice();
        ...
        var t, i, n = e[0] / 255, r = e[1] / 255, o = e[2] / 255, a = e[3], s = Math.max(n, r, o),
            l = Math.min(n, r, o), u = s - l, d = s + l, _ = .5 * d;
...
var g_ugYoutubeAPI = new UGYoutubeAPI, g_ugVimeoAPI = new UGVimeoAPI, g_ugHtml5MediaAPI = new UGHtml5MediaAPI,
    g_ugSoundCloudAPI = new UGSoundCloudAPI, g_ugWistiaAPI = new UGWistiaAPI;

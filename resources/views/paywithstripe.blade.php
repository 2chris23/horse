    ...
    <div class="card">
        <div class="card-block">
            ...
            <div class="row">
                <div class="container">
                    <div class="row">
                        <div class=" col-xs-offset-3 col-xs-6 m-t-25">
                                    ...
                                    <form class="form-horizontal" method="POST" id="payment-form" role="form"
                                        ...
                                        <div class="form-group{{ $errors->has('card_no') ? ' has-error' : '' }}">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input id="card_no" type="text" class="form-control" name="card_no" value="4242424242424242" autofocus>
                                        ...
                                        <div class="form-group{{ $errors->has('ccExpiryMonth') ? ' has-error' : '' }}">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input id="ccExpiryMonth" type="text" class="form-control" name="ccExpiryMonth" value="02" autofocus>
                                        ...
                                        <div class="form-group{{ $errors->has('ccExpiryYear') ? ' has-error' : '' }}">
                                            ...
                                            <div class="col-md-6">
                                                <input id="ccExpiryYear" type="text" class="form-control" name="ccExpiryYear" value="2020" autofocus>
                                        ...
                                        <div class="form-group{{ $errors->has('cvvNumber') ? ' has-error' : '' }}">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input id="cvvNumber" type="text" class="form-control" name="cvvNumber" value="666" autofocus>
                                        ...
                                        <div class="form-group{{ $errors->has('amount') ? ' has-error' : '' }}">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input id="amount" type="text" class="form-control" name="amount" value="50.5" autofocus>

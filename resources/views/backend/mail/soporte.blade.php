...
$contenido = $dat['contenido'];
    ...
    //$linktyoutube =config::get('otra.hyoutube');
        $naranja = "#fa6900";
            ...
            /*
            $logo2= (isset($logo2))?$logo2:'';
            $logo3= (isset($logo3))?$logo3:'';
            $logo4= (isset($logo4))?$logo4:'';
            $logo5= (isset($logo5))?$logo5:url('img/preview.jpg');
            $logo6= (isset($logo6))?$logo6:'';
            $logo7= (isset($logo7))?$logo7:'';
            $logo8= (isset($logo8))?$logo8:'';
            */
            /*Logos laterales*/
